package net.kunmc.lab.paperplugintemplate.util.task;
      ...
      public void run() {
        if (isRunning) {
          ...
          if (average > QueuedExecutor.this.numberOfActionPerSec * 0.9) {
            Candidate = (int) max(1000, (QueuedExecutor.this.numberOfActionPerSec * 1.2));
          } else {
            Candidate = (int) max(1000, (QueuedExecutor.this.numberOfActionPerSec * 0.9));
          }
